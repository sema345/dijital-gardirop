...
const DATA = [
    { id: '1', title: 'Beyaz Basic Tişört', price: '299 TL', image: require('./assets/icon.png') },
    { id: '2', title: 'Siyah Sweatshirt', price: '549 TL', image: require('./assets/icon.png') },
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>alt Giyim</Text>
            </View>
